...
generate_data.py
-----------------
Script de geração dos dados brutos (fornecido pela Engenharia).
Gera os arquivos `transacoes.csv` e `cotacoes.csv` usados pelo pipeline
em `pipeline.py`.
...
# duplica as 15 primeiras linhas para simular registros duplicados no log
